...
Feature: Step 28 and Step 29
  ...
  # Upload images
    And I output "[SC - TESTCASE 28 - begin]"
  ...
  # Question 1: Add image to optiontext
    ...
    And I click on "Edit" "link" in the "SC-Question-002" "table_row"
  ...
  # Change quiz title
    ...
    And I set the following fields to these values:
      | id_name | Quiz 0 |
    And I press "id_submitbutton"
    And I output "[SC - TESTCASE 28 - end]"

  # Restore
    And I output "[SC - TESTCASE 29 - begin]"
  ...
  # Check if the altered SC-Question-001 exists twice in the question bank
    ...
    Then element with css "tr:contains('SC-Question-001') td[class='modifiername']:contains('Admin User')" should exist
    And element with css "tr:contains('SC-Question-001') td[class='modifiername']:contains('T1 Teacher')" should exist
    And element with css "tr:contains('SC-Question-002')" should exist

  # Check for images
    When I click on css "tr:contains('SC-Question-001'):contains('T1 Teacher1') a[title='Preview']"
    ...
    When I click on css "tr:contains('SC-Question-001'):not(:contains('T1 Teacher1')) a[title='Preview']"
    And I switch to "questionpreview" window
    ...
    When I click on css "tr:contains('SC-Question-002') a[title='Preview']"
    And I switch to "questionpreview" window
    Then element with xpath "[alt='testimage1AltDescription']" should exist
    And I should not see "testimage1AltDescription"
    And element with xpath "[alt='testimage2AltDescription']" should exist
    ...
    And I output "[SC - TESTCASE 29 - end]"
