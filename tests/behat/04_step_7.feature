@qtype @qtype_sc @qtype_sc_step_7
Feature: Step 7
  ...
  @javascript @_switch_window @core_filepicker
  Scenario: TESTCASE 7.
  # When creating a SC question add "Image"
  # (and other html-editor possibilities) in the
  # stem and in the options.
  # Images and so on are displayed and work.

    And I output "[SC - TESTCASE 7 - begin]"
  ...
  # Add video to question stem
    ...
    And I attach file "/var/www/moodle/question/type/sc/tests/media/testvideo1.mp4" to "input[name='repo_upload_file']"
  ...
  # Add image to feedback
    ...
    And I press "Browse repositories..."
    And I click on "URL downloader" "link" in the ".fp-repo-area" "css_element"
    And I set the field "fileurl" to "http://127.0.0.1/question/type/sc/tests/media/testimage3.png"
    And I press "Download"
    ...
    # Preview
    When I click on "Preview" "link" in the "SC-Question-001" "table_row"
    ...
    And I output "[SC - TESTCASE 7 - end]"
