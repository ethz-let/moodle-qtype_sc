...
Feature: Step 7
  ...
  Scenario: Testcase 9, 10, 11 - Part 1 for Moodle ≤ 4.2
  ...
  @javascript @_switch_window
  Scenario: Testcase 9, 10, 11 - Part 1 for Moodle ≥ 4.3
  ...
  @javascript @_switch_window
  Scenario: Testcase 9, 10, 11 - Part 2 for Moodle ≤ 4.2
    Given the site is running Moodle version 4.2 or lower
  ...
  @javascript @_switch_window
  Scenario: Testcase 9, 10, 11 - Part 2 for Moodle ≥ 4.3
    Given the site is running Moodle version 4.3 or higher
  ...
  @javascript @_switch_window
  Scenario: Testcase 9, 10, 11 - Part 3 for Moodle ≤ 4.2
    Given the site is running Moodle version 4.2 or lower
  ...
  @javascript @_switch_window
  Scenario: Testcase 9, 10, 11 - Part 3 for Moodle ≥ 4.3
    Given the site is running Moodle version 4.3 or higher
